...
execute_process(
  COMMAND "/usr/bin/git" show-ref "boost-1.74.0"
  WORKING_DIRECTORY "/Users/natasamihaleva/projectCXX/Lab2/cmake-build-debug/_deps/boost-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "boost-1.74.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("boost-1.74.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/boost-1.74.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/natasamihaleva/projectCXX/Lab2/cmake-build-debug/_deps/boost-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/natasamihaleva/projectCXX/Lab2/cmake-build-debug/_deps/boost-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
