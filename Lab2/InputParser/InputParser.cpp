...
InputParser::InputParser(int argc, char** argv) {
    ...
    desc.add_options()
            ...
            ("nameStrategy, n", po::value<std::vector<std::string>  >(&strategyName), "Show --strategy={ALWAYS_VOICE_C|ALWAYS_VOICE_D|RANDOM_VOICE|PERCENTAGE_CHOICE|name5|name6|")
            ...
            ("configs, c", po::value<std::vector <std::string> >(&configsLine), "Show --configs=[confFile1|confFile2|confFile3 .txt")
